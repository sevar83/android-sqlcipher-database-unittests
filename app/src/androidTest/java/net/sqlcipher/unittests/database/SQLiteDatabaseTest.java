...
package net.sqlcipher.unittests.database;
...
public class SQLiteDatabaseTest {
    ...
    public void setUp() throws Exception {
        ...
        targetContext.deleteDatabase(DATABASE_FILE_NAME);
        mDatabaseFilePath = targetContext.getDatabasePath(DATABASE_FILE_NAME).getPath();
        mDatabaseFile = targetContext.getDatabasePath(DATABASE_FILE_NAME);
    ...
    public void testOpenDatabase() {
        ...
        SQLiteDatabase db = SQLiteDatabase.openDatabase(mDatabaseFilePath, (char[]) null,
        ...
        db = SQLiteDatabase.openOrCreateDatabase(dbFile.getPath(), (char[]) null, factory);
        assertNotNull(db);
        db.close();
        dbFile.delete();
        ...
        db = SQLiteDatabase.create(factory, (char[]) null);
        assertNotNull(db);
        db.close();
    }
    ...
    public void testAccessPageSize() {
        ...
        try {
            database = SQLiteDatabase.openOrCreateDatabase(databaseFile.getPath(), (char[]) null, null);
    ...
    public void testIsReadOnly() {
        ...
        SQLiteDatabase database = null;
        try {
            database = SQLiteDatabase.openDatabase(mDatabaseFilePath, (char[]) null, null,
