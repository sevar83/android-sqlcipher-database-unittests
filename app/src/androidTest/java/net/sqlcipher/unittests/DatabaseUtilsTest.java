...
package net.sqlcipher.unittests;
...
import static net.sqlcipher.unittests.TestConstants.EPSILON;
...
public class DatabaseUtilsTest {
    ...
    public void testCreateDbFromSqlStatements() {
        ...
        DatabaseUtils.createDbFromSqlStatements(mMockContext, dbName, 1, sqls);

        SQLiteDatabase db = mMockContext.openOrCreateDatabase(dbName, 0, null);
        ...
        mMockContext.deleteDatabase(dbName);
    }*/
